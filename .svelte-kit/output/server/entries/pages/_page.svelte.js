...
const css = {
  code: `section.svelte-2q02cd.svelte-2q02cd{font-family:'Helvetica', 'Arial', sans-serif;background-color:#ffffff;margin:auto;max-width:600px;width:100%;margin-top:25px;margin-bottom:25px}h1.svelte-2q02cd.svelte-2q02cd{margin:0px 0px 25px 0px;font-family:'Helvetica', 'Arial', sans-serif;font-size:2.8rem;font-weight:bold;color:#121212;text-decoration:none;text-align:center;padding-bottom:25px;border-bottom:1px solid rgb(180, 180, 180)}.bio-text.svelte-2q02cd.svelte-2q02cd{font-family:'EB Garamond', 'Georgia', 'Times New Roman', Times, serif;color:#121212;font-size:1.2rem;line-height:1.6;text-align:left;font-weight:100}.bio-text.svelte-2q02cd a.svelte-2q02cd{text-decoration:underline!important;text-decoration-thickness:0.5px!important;text-underline-offset:2px!important;color:#121212!important;font-weight:100!important}a:hover{color:black!important}.projects-grid.svelte-2q02cd.svelte-2q02cd{display:grid;grid-template-columns:1fr;gap:1rem;width:100%;max-width:1600px;justify-content:center}@media(min-width: 500px){.projects-grid.svelte-2q02cd.svelte-2q02cd{grid-template-columns:repeat(auto-fill, minmax(200px, 300px))}}.projects-grid.svelte-2q02cd a.svelte-2q02cd{text-decoration:none}.project-card.svelte-2q02cd.svelte-2q02cd{width:100%;max-width:100%;background:#fff;border-radius:8px;overflow:hidden;transition:transform 0.2s ease-in-out;box-sizing:border-box}.project-card.svelte-2q02cd.svelte-2q02cd:hover{transform:translateY(-4px)}.project-image.svelte-2q02cd.svelte-2q02cd{width:100%;height:200px;overflow:hidden}.project-image.svelte-2q02cd img.svelte-2q02cd{width:100%;height:100%;object-fit:cover}.project-image.placeholder.svelte-2q02cd.svelte-2q02cd{background-color:#f5f5f5}.project-content.svelte-2q02cd.svelte-2q02cd{padding-top:0.5rem;padding-bottom:0.5rem}.project-content.svelte-2q02cd a.project-title.svelte-2q02cd{font-family:"EB Garamond", "Georgia", "Times New Roman", Times, serif;display:block;margin-bottom:0.2rem;font-size:1.0rem;line-height:1.2;color:#121212}.project-content.svelte-2q02cd p.svelte-2q02cd{font-size:0.6rem;color:#666;margin:0;text-transform:uppercase;font-weight:100;letter-spacing:0.5px}`,
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="svelte-2q02cd" data-svelte-h="svelte-1b6ps7f"><h1 class="heading svelte-2q02cd">Zach Levitt</h1> <p class="bio-text svelte-2q02cd">Hello, I&#39;m currently making maps and interactive graphics at the <a href="https://www.nytimes.com/by/zach-levitt" class="svelte-2q02cd">New York Times</a>. Previously, I worked at the <a href="https://www.washingtonpost.com/people/zach-levitt/" class="svelte-2q02cd">Washington Post</a>, <a href="https://www.npr.org/people/966348865/zach-levitt" target="_blank" class="svelte-2q02cd">NPR</a> and the <a href="https://www.latimes.com/people/zach-levitt" class="svelte-2q02cd">Los Angeles Times</a>. I have a background in cartographic design, geospatial analysis and front-end development.</p> <p class="bio-text svelte-2q02cd">Please be in touch via levittzach [at] gmail</p> <p class="bio-text svelte-2q02cd">Here are some selected stories I have worked on:</p></section> ${projects && projects.length > 0 ? `<div class="projects-grid svelte-2q02cd">${each(projects, (project) => {
    return `<div class="project-card svelte-2q02cd">${project.imageLink ? `<a${add_attribute("href", project.toLink, 0)} target="_blank" class="svelte-2q02cd"><div class="project-image svelte-2q02cd"><img src="${"images/" + escape(project.imageLink, true)}"${add_attribute("alt", project.title, 0)} class="svelte-2q02cd"></div> </a>` : `<a${add_attribute("href", project.toLink, 0)} class="svelte-2q02cd"><div class="project-image placeholder svelte-2q02cd"></div> </a>`} <div class="project-content svelte-2q02cd"><a class="project-title svelte-2q02cd"${add_attribute("href", project.toLink, 0)}>${escape(project.title)}</a> <p class="svelte-2q02cd">${escape(project.organization)}</p></div> </div>`;
  })}</div>` : ``}`;
});
export {
  Page as default
